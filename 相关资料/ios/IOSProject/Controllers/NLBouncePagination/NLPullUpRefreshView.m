...
#define REFRESH_PULL_UP_STATUS @"继续拖动查看图文详情"
// 加载中
...
- (id)initWithFrame:(CGRect)frame
{
 ...
 //       self.refreshArrow = [[UIImageView alloc] init];

        UIImageView * imageline = [[UIImageView alloc] initWithFrame:CGRectMake(20 ,(floorf(REFRESHER_HEIGHT) / 2), 80, 1)];
        imageline.backgroundColor = [UIColor colorFromHexCode:@"#757575"];
        [self addSubview:imageline];
        UIImageView * imageline2 = [[UIImageView alloc] initWithFrame:CGRectMake(self.width / 2 + 60 ,(floorf(REFRESHER_HEIGHT) / 2), 80, 1)];
        imageline2.backgroundColor = [UIColor colorFromHexCode:@"#757575"];
...
//            self.refreshLabel.text = REFRESH_RELEASED_STATUS;
            ...
            self.refreshLabel.text = REFRESH_PULL_UP_STATUS;
            self.refreshLabel.textColor = [UIColor colorFromHexCode:@"#757575"];
