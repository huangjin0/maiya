...
- (void)initUI {
    ...
    _pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, self.frame.size.height - 30, self.frame.size.width, 10)];
...
//        _imgNext.image = [UIImage imageNamed:nextImage];
    [_imgPrev setImageWithURL:prevImage];
    [_imgCurrent setImageWithURL:curImage];
    [_imgNext setImageWithURL:nextImage];
    }
