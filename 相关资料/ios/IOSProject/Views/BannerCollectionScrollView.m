...
@interface BannerCollectionScrollView (){
    //循环滚动的三个视图
...
@implementation BannerCollectionScrollView
...
//    _imageNameArray = [NSMutableArray arrayWithObjects:@"640",@"hongzao",@"jirou",nil];
...
- (void)setAdTitleArray:(NSArray *)adTitleArray withShowStyle:(id)adTitleStyle{
...
//    _pageControl.backgroundColor = [UIColor colorFromHexCode:@"#efeef4"];
//    _pageControl.layer.cornerRadius = 6.0;
